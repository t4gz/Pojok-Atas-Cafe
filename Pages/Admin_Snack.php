...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-flex">
                        <h1 class="h4 mb-0 darkf">Data Snack</h1>    
                    </div>
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                <div class="card-header bg-dark py-3 ">
                                    <h6 class="m-0 font-weight-normal text-light">Tambah Data Snack</h6>
                                </div>
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data Snack baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Snack.php?p=Snack_Tambah" class="btn btn-dark btn-icon-split">
    ...
    <br>
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                <div class="card-header bg-dark py-3 ">
                                    <h6 class="m-0 font-weight-normal text-light">Lihat Tabel Snack</h6>
                                </div>
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data Snack baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Snack.php?p=Snack_View" class="btn btn-dark btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                ...
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data Snack baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Snack.php?p=Snack_EditHapus" class="btn btn-dark btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
...
$pages_dir='.';
if(!empty ($_GET['p'])){
$pages=scandir($pages_dir.'/data',0);
unset($pages[0], $pages[1]);
$p=$_GET['p'];
if(in_array($p.".php", $pages)){
    include($pages_dir.'/data/'.$p.'.php');
}else{
