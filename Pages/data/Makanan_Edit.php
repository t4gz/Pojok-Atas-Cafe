...
<form action="./Makanan_UpdateProcess.php" method="POST" enctype="multipart/form-data" class="mx-4 mt-4">
    ...
    <div class="mb-3">
        ...
        <br />
        <img src="uploads/<?php echo htmlspecialchars($foto); ?>" alt="Foto Makanan" style="width: 200px; height: auto;" />
    </div>
    <button type="submit" class="btn btn-dark text-light">Update</button>
    <a href="../Admin_Snack.php?p=Makanan_EditHapus" class="btn btn-secondary">Batal</a>
</form>
                                </div>
                            </div>
                        </div>
