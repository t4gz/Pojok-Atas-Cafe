        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-flex">
                        <h1 class="h4 mb-0 darkf">Data Makanan</h1>    
                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                <div class="card-header bg-dark py-3 ">
                                    <h6 class="m-0 font-weight-normal text-light">Tambah Data Makanan</h6>
                                </div>
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data makanan baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Makanan.php?p=Makanan_Tambah" class="btn btn-dark btn-icon-split">
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                <div class="card-header bg-dark py-3 ">
                                    <h6 class="m-0 font-weight-normal text-light">Lihat Tabel Makanan</h6>
                                </div>
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data makanan baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Makanan.php?p=Makanan_View" class="btn btn-dark btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
                        ...
                        <div class="col-sm-4">
                             ...
                             <div class="card shadow  mb-4 darkbg">
                                ...
                                <div class="card-body">
                                    <p>Opsi ini untuk menambahkan data makanan baru untuk ditampilkan ke Pelanggan.</p>
                                    <hr>
                                    <a href="Admin_Makanan.php?p=Makanan_EditHapus" class="btn btn-dark btn-icon-split">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-arrow-right"></i>
                                        </span>
